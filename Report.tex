...
of the utmost importance to derive an architecture fitting of our needs.
...
\begin{figure}[h]
    ...
    \caption{A graph of the service architecture. The clouds represent clusters of multiple microservices.}
    \label{fig:AR}
\end{figure}
...
Service and knows what content this user has uploaded.
